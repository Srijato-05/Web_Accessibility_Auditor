    ...
    <div className="min-h-screen bg-background text-on-surface p-8 max-w-4xl mx-auto pb-32 fade-in-up">
      <header className="mb-8 border-b border-surface-border pb-8">
        ...
        <div className="flex items-center gap-3">
            <div className="bg-primary/10 text-primary p-2 rounded-md border border-primary/45 shadow-ambient">
                <ShieldCheck size={24} />
            </div>
            <h1 className="text-display font-medium text-2xl font-heading">Privacy & Security</h1>
        </div>
        <p className="text-on-surface-variant text-sm mt-2 tracking-wide">Luminescent Auditor organizational compliance policies.</p>
      </header>
